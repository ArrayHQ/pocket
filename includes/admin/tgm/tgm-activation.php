 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Pocket
...
add_action( 'tgmpa_register', 'pocket_register_required_plugins' );
 ...
 */
function pocket_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'pocket_wpforms_shareasale_id' );

function pocket_wpforms_shareasale_id( $shareasale_id ) {
